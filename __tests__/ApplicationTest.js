...
describe('problem1', () => {
  ...
  test('case4', () => {
    expect(problem1([341, 342], [99, 100])).toEqual(2);
  });
...
describe('problem2', () => {
  ...
  test('case3', () => {
    expect(problem2('zzbbbz')).toEqual('z');
  });
  ...
  test('case5', () => {
    expect(problem2('czzbbzc')).toEqual('czc');
  });
});
...
describe('problem3', () => {
  ...
  test('case4', () => {
    expect(problem3(9999)).toEqual(12000);
  });
});
...
describe('problem4', () => {
  ...
  test('case1', () => {
    expect(problem4('My love, 그날에 우린')).toEqual('Nb olev, 그날에 우린');
  });
});
...
describe('problem5', () => {
  ...
  test('case4', () => {
    expect(problem5(99999)).toEqual([1, 4, 1, 4, 1, 4, 1, 4, 9]);
  });
});
