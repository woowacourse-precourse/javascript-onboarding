...
### ✔️ 기능 1. 입력받은 user / friends 를 활용하여 유저의 친구 목록을 만드는 함수
<br>
...
### ✔️ 기능 2. 입력받은 user 를 활용하여 유저가 포함되지 않은 배열 선별하는 함수
<br>
...
### ✔️ 기능 3. user의 친구들과 친구 관계인 목록 작성 함수
<br>
...
### ✔️ 기능 4. 함께 아는 친구의 수와 방문 횟수로 추천 점수를 카운팅하는 함수
<br>
