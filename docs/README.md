...
- [] 2. 사용자와 함께 아는 친구 수를 기준으로 추천 점수를 구한다. +10점
- [] 3. 타임라인에 방문한 횟수를 기준으로 추천 점수를 구한다. +1점
- [] 4. 두 개를 합산한 추천 점수를 기준으로 오름차순으로 정렬해 결과값에 담아 최대 5명 까지 리턴한다.
- [] 5. 추천 점수가 0점인 경우는 제외한다.
- [] 6. 추천 점수가 같은 경우는 이름 순으로 정렬한다.
