...
3. for in => 다른 반복문 사용하자(파기)

- for in 성능 문제에 대한 얘기가 많다
- 대안. Object.entries() 사용
- 비교 결과. for in은 여러번의 테스트에서 편차가 크지않은 반면, Object.entries()는 편차가 다소 존재
- 다만, 테스트 결과가 Object.entries()가 더 빠른 경우가 존재
- 안정적인 결과를 위해 for in 유지하는 것으로 결정
