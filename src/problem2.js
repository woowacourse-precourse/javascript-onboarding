function problem2(cryptogram) {
  ...
  if(CHECK_WORD_LENGTH_BETWEEN_ONE_TO_THOUSAND(cryptogram) === false){
    return "단어의 길이가 1미만, 1000초과입니다."
  }

  if(CHECK_WORD_IS_ALL_LOWERCASE(cryptogram) === false){
    return "단어 중 알파벳 소문자가 아닌 문자가 존재합니다."
  }
