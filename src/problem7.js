...
const getExcludedFriends = (user, friendsMap) => {
...
const scoreFriendsMayKnow = (user, friendsMap, excludedFriends) => {
...
const scoreVisitors = (scoreMap, visitors, excludedFriends) => {
...
const limitRecommendation = (scoreMap) => {
  const recommendation = scoreMap.map((friend) => friend[0]).slice(0, 5);
  return recommendation;
};

// solution
const solution = (user, friends, visitors) => {
